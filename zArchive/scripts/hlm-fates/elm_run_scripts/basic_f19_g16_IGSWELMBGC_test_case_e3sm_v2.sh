...
export CASE_NAME=/output/f19_g16.IGSWELMBGC.${date_var}
cd /E3SM/cime/scripts
./create_newcase --case ${CASE_NAME} --res f09_g16 --compset IGSWELMBGC --mach docker --compiler gnu
cd ${CASE_NAME}
# =======================================================================================
...
./xmlchange --id ELM_ACCELERATED_SPINUP --val off
